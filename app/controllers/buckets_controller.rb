class BucketsController < ApplicationController
  ...
  def record
    ...
    email_params[:text] = email_params[:text].encode!(Encoding::UTF_8) if email_params[:text]
    email_params[:html] = email_params[:html].encode!(Encoding::UTF_8) if email_params[:html]
